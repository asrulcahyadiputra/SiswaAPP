...
// MARK: - Welcome
struct DetailMapels: Codable {
    let success: DetailMapelResponse
}

// MARK: - Success
struct DetailMapelResponse: Codable {
    let status: Bool
    let dataTa: [DataTa]
    let dataGuru: [DataGuru]
    let dataKompetensi: [JSONAny]
    let message: String
